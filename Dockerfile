...
FROM registry.access.redhat.com/ubi8/ubi-minimal:8.10-1789361795 as build_base
...
###############################################################################
FROM registry.access.redhat.com/ubi8/ubi-minimal:8.10-1789361795 AS runtime
